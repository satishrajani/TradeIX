...
public class Verify_employee_deletion {
...
String b1 = "{\"name\":\"kumartest\",\"salary\":\"123\",\"age\":\"23\"}";
       ...
       System.out.println("id got from from system" + emplyoeeid);
        ...
        RestAssured.baseURI = "http://dummy.restapiexample.com/api/v1/delete/"+emplyoeeid;

        Response res1 = given().when().delete().then().statusCode(200).contentType(ContentType.HTML).extract()
                .response().prettyPeek();
